        ...
        torch.save(
            {
                ...
                'loss': loss
            }, f"./models/tile_classify/tile_classify_{epoch}.pth")
...
train_dataset = ImageDataset(pd.read_csv("./data/tile_classify_train.csv"), mode='train')
val_dataset = ImageDataset(pd.read_csv("./data/tile_classify_val.csv"), mode='val')
